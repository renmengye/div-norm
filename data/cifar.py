...
class CIFARDataset():
  ...
  def __init__(self,
    ...
    self.whiten = whiten
    self.div255 = div255
    assert not (div255 and
                whiten), "Applying both /255 and whitening is not recommended."
...
class CIFAR10Dataset(CIFARDataset):
  ...
  def read_data(self):
    return cifar_input.read_CIFAR10(self.folder)


class CIFAR100Dataset(CIFARDataset):

  def read_data(self):
    return cifar_input.read_CIFAR100(self.folder)
